...
public struct CharData: CustomDebugStringConvertible {
    ...
    /// Relay patch: cells skipped over by cursor-positioning TUIs hold a NUL
    /// rune; plain-text extraction needs to tell them apart from real spaces.
    public var isNull: Bool { code == 0 }
